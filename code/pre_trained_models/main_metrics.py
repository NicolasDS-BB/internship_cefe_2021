...
list_bdd = ['MART','JEN','SMALLTEST','BIGTEST'] #"['CFD','MART','JEN','SCUT-FBP','SMALLTEST','BIGTEST']"
model_name = 'VGG16'  # 'vgg16, resnet (...)'
#weights = 'vggface' #'imagenet','vggface'
list_weights = ['vggface','imagenet'] #['vggface','imagenet','vggplace']
list_metrics = ['L0','kurtosis','gini_flatten'] #['L0','L1','gini_flatten','gini_channel','gini_filter','kurtosis']
